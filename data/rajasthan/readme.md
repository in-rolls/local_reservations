...
**The parsed data for Rajasthan is in [local_elections_rajasthan](https://github.com/in-rolls/local_elections_rajasthan)** — gp_head, 2005, 2010, 2015, 2020. It was split into its own repository, so it is counted in the [top-level readme](../../readme.md) but has no rows here.
