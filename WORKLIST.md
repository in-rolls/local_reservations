...
|---|---|---|---|---|---|
| 16,695 | Jharkhand | 2015 | `gp_ward` | some districts are not held | 10 of 24 districts, roughly 16,695 rows missing |
| 2,444 | Jharkhand | 2015 | `gp_ward` | some rows do not identify a distinct seat | largest group 250 rows |
| 2,382 | Jharkhand | 2015 | `gp_ward` | the row does not say which panchayat | Chatra 1,475, Godda 252, Jamtara 227 |
...
| 1,145 | Jharkhand | 2015 | `gp_head` | the row does not say which panchayat | Chatra 415, Latehar 213, Jamtara 192 |
...
| 598 | Jharkhand | 2015 | `block_member` | the row does not say which seat | Hazaribag 334, Ramgarh 145, Dumka 36 |
...
| 402 | Jharkhand | 2015 | `block_member` | some districts are not held | 22 of 24 districts, roughly 402 rows missing |
| 320 | Jharkhand | 2015 | `zp_member` | some districts are not held | 9 of 24 districts, roughly 320 rows missing |
| 314 | Bihar | 2016 | `kachahari_member` | the source states a caste but no gender | GAYA 85, PASCHIM CHAMPARAN 54, PATNA 45 |
| 309 | Jharkhand | 2015 | `gp_head` | some rows do not identify a distinct seat | largest group 10 rows |
...
| 3 | Jharkhand | 2015 | `zp_member` | the row does not say which seat | Chatra 2, Godda 1 |
