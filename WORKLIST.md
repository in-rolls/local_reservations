...
|---|---|---|---|---|---|
| 20,963 | Jharkhand | 2015 | `gp_ward` | some districts are not held | 11 of 24 districts, roughly 20,963 rows missing |
...
| 146 | Jharkhand | 2015 | `gp_head` | some rows do not identify a distinct seat | largest group 9 rows |
