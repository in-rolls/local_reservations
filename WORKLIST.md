...
|---|---|---|---|---|---|
| 21,639 | Jharkhand | 2015 | `gp_ward` | some districts are not held | 11 of 24 districts, roughly 21,639 rows missing |
...
| 717 | Jharkhand | 2015 | `gp_ward` | the row does not say which seat | Godda 322, Lohardaga 286, Simdega 44 |
| 704 | Jharkhand | 2015 | `block_member` | the row does not say which seat | Hazaribag 379, Ramgarh 147, East Singhbhum 43 |
| 635 | Jharkhand | 2015 | `gp_ward` | the row does not say which panchayat | Godda 322, Lohardaga 286, Bokaro 24 |
| 595 | Jharkhand | 2015 | `gp_ward` | some rows do not identify a distinct seat | largest group 12 rows |
| 510 | Jammu & Kashmir | 2010 | `gp_ward` | some rows do not identify a distinct seat | largest group 27 rows |
| 426 | Jharkhand | 2015 | `block_member` | some rows do not identify a distinct seat | largest group 51 rows |
...
| 191 | Jharkhand | 2015 | `gp_head` | some rows do not identify a distinct seat | largest group 4 rows |
| 159 | Jharkhand | 2015 | `gp_head` | the row does not say which panchayat | Pakur 106, Sahebganj 37, Dumka 14 |
...
| 123 | Jharkhand | 2015 | `gp_ward` | the seat identifier is an image, not text | — |
